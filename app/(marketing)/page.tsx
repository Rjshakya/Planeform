...
import { Autonio, Chart21, ChartSuccess, LinkSquare, TextBlock } from "iconsax-reactjs";
...
export default function Landing() {
  return (
    <>
      <main className="grid grid-cols-1 px-3 md:px-1 relative bg-background z-10 mb-[700px]  sm:mb-[400px] pb-28 rounded-b-2xl border-b-2 dark:border-b-0 ">
        ...
        <section id="features" className="w-full h-full  px-2 md:px-6 mt-48 ">
          <div className="max-w-3xl mx-auto">
            <div className="text-left mb-10 md:mb-14 px-1">
              <h2 className="text-3xl md:text-4xl font-semibold tracking-tighter">Features</h2>
              <p className="text-muted-foreground mt-2 max-w-4xl mx-auto font-medium">
                Everything you need to build, share, and analyze high‑converting forms.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 ">
              ...
              <div className=" border text-card-foreground p-6 grid gap-4">
                <Button variant={"outline"} size={"icon"} className="my-1 size-12">
                  <TextBlock
                    variant="Bold"
                    className="size-8"
                  />
              ...
              <div className=" border text-card-foreground p-6 grid gap-4">
                ...
                <div className="pl-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Track views, completions, and drop‑offs to optimize conversions.
                  </p>
                </div>
              ...
              <div className=" border text-card-foreground p-6 grid gap-4">
                ...
                <div className="pl-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Share links or embed anywhere with responsive, accessible UI.
                  </p>
                </div>
              ...
              <div className=" border text-card-foreground p-6 grid gap-4">
                ...
                <div className="pl-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Connect with your stack using webhooks and native integrations.
                  </p>
                </div>
        ...
        <section id="comparison" className="w-full h-full  px-2 md:px-6 mt-32 ">
          <div className="max-w-3xl mx-auto">
            <div className="text-left mb-10 md:mb-14 px-1">
              <h2 className="text-3xl md:text-4xl font-semibold tracking-tighter">Planetform vs alternatives</h2>
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[720px] border">
                ...
                <div className="grid grid-cols-4 border-b">
                  ...
                  <div className="p-4 text-sm font-medium">Free • Cheap at scale</div>
                ...
                {/* Design */}
                <div className="grid grid-cols-4 border-b">
                  <div className="p-4 text-sm text-muted-foreground">Design</div>
                ...
                {/* Ease of use */}
                <div className="grid grid-cols-4 border-b">
                  <div className="p-4 text-sm text-muted-foreground">Ease of use</div>
                  <div className="p-4 text-sm font-medium">Intuitive • minimal UI</div>
                ...
                {/* Builder */}
                <div className="grid grid-cols-4 border-b">
                  <div className="p-4 text-sm text-muted-foreground">Builder</div>
                  <div className="p-4 text-sm font-medium">Block‑based • drag & drop</div>
                ...
                {/* Customization */}
                <div className="grid grid-cols-4 border-b">
                  <div className="p-4 text-sm text-muted-foreground">Customization</div>
                  <div className="p-4 text-sm font-medium">High • flexible controls</div>
                ...
                <div className="grid grid-cols-4">
                  <div className="p-4 text-sm text-muted-foreground">Overall value</div>
                  <div className="p-4 text-sm font-medium">Best value for most teams</div>
      ...
      {/* Footer */}
      <footer className="w-full px-2 md:px-6 mt-24 fixed bottom-0 -z-0 bg-accent dark:bg-accent/20 ">
        <div className="w-full border-t pt-10 pb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2 flex flex-col justify-end gap-3">
              ...
              <p className="text-sm text-muted-foreground max-w-md">
                Build beautiful, modern forms with an intuitive block-based editor.
              </p>
              <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} Planetform. All rights reserved.</p>
          ...
          <div className="w-full mt-10">
            <h1 className="text-7xl md:text-9xl font-bold tracking-tighter ">Planetform</h1>
          </div>
        </div>
      </footer>
    </>
